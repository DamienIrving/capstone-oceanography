...
In the [lesson on command line programs](http://swcarpentry.github.io/python-novice-inflammation/10-cmdline/) 
we met `sys.argv`, 
...
> Iris and xarray also come with a bunch of convenience functions for doing typical weather/climate/ocean tasks
> (calculating climatologies, anomalies, etc), which can be a pain using numpy. 
